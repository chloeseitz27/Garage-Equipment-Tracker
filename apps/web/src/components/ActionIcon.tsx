export function ActionIcon({ name }: { name: 'save' | 'delete' | 'edit' | 'add' | 'cancel' | 'refresh' | 'undo' | 'chevron' }): JSX.Element {
  return (
    <svg
    ...
    >
      {name === 'save' ? (
        ...
        <>
          ...
          <path d="M6.3 6.3A8 8 0 0 1 20 12M17.7 17.7A8 8 0 0 1 4 12" />
        </>
      ) : name === 'undo' ? (
        <>
          <path d="m7 6-4 4 4 4" />
          <path d="M3 10h10a6 6 0 0 1 0 12h-3" />
        </>
